# UC — Publish Instagram Reels

| | |
|---|---|
| FR Code | 3.8.13 |
| Feature | Publish Instagram Reels |
...
Tự động đăng Reels lên Instagram qua API chính thức, khi Task loại Post đã hoàn thành Approval Sequence.

## 2. User Story

Là một Member,
tôi muốn hệ thống tự động đăng Reels lên Instagram,
...
- Publisher service gọi API chính thức của Instagram bằng token đã connect (FR 3.8.1) để đăng Reels.
...
- Publish Reels lên Instagram thành công qua API thật, trạng thái cập nhật đúng.
