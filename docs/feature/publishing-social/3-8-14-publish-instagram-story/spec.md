# UC — Publish Instagram Story

| | |
|---|---|
| FR Code | 3.8.14 |
| Feature | Publish Instagram Story |
...
Tự động đăng Story lên Instagram qua API chính thức, khi Task loại Post đã hoàn thành Approval Sequence.

## 2. User Story

Là một Member,
tôi muốn hệ thống tự động đăng Story lên Instagram,
...
- Publisher service gọi API chính thức của Instagram bằng token đã connect (FR 3.8.1) để đăng Story.
...
- Publish Story lên Instagram thành công qua API thật, trạng thái cập nhật đúng.
