...
| TC-07 | Đổi role MANAGER duy nhất xuống CREATOR/CLIENT | AC (giảm quyền) | 409 `LAST_OWNER_CANNOT_BE_REMOVED` | Error case | Pass |
...
| TC-11 | MANAGER đổi role chính mình xuống CREATOR khi là MANAGER duy nhất | Edge (mục 7) | 409 `LAST_OWNER_CANNOT_BE_REMOVED` (không có ngoại lệ tự đổi) | Edge case | Pass |
