...
| Role | AI Engineer |
| Sprint | Sprint 15 |
| Ngày nộp | *(Chưa nộp — deadline: 2026-12-15)* |
...
|---|---|---|---|---|
| DA-E42-02 | [DA-E42-02](https://letritrung2605.atlassian.net/browse/DA-E42-02) | Unit tests for ai-service (content, RAG, image generation) | 🔴 Critical | |
