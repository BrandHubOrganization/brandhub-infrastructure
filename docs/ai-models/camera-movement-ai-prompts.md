**Title:** Camera Movement AI Prompts

**Source:** [https://aicameramovements.com/](https://aicameramovements.com/)

---

# Page Structure Map
```text
Camera Movement AI Prompts
├── Static shot
├── Pan right
├── Pan left
├── Whip pan right
...
Movement library **Find the camera move that fits your shot.**

Search by movement name or filter by category. The looping previews make it easier to compare direction, speed and framing before generating.
