...
| OpenAPI reference document | `brandhub-infrastructure/docs/api/DA-E07-06-openapi-spec-as.md` | This file |
...
└── docs/api/
    └── DA-E07-06-openapi-spec-as.md   ← this reference document
```
