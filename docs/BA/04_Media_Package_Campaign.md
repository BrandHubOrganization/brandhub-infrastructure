...
```
1. Owner tạo Workspace + gán Manager (xem 01_Organization_Structure.md)
...
- **Lưu ý mức độ chi tiết ở giai đoạn này**: backlog sinh ra CHƯA đầy đủ quy trình triển khai, chưa có yêu cầu cụ thể — chỉ mới là tên công việc + thời gian thông thường. Chi tiết hóa xảy ra ở bước Identify Task Detail (xem [05_Content_Task_Workflow.md](05_Content_Task_Workflow.md)).
