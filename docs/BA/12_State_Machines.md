...
> Kỹ thuật: bảng `TaskApproval` phải lưu theo từng step riêng (không chỉ 1 field `status` tổng) để giữ lịch sử approve cũ khi step sau bị reject — xem [11_Data_Entities_Glossary.md](11_Data_Entities_Glossary.md).
...
- `PRE_LIVE`: chuẩn bị (idea, script, setup, quay chuẩn bị — xem checklist ở [05_Content_Task_Workflow.md](05_Content_Task_Workflow.md) mục 3).
