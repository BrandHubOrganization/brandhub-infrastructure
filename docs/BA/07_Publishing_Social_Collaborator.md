...
Tất cả role: MEMBER. Đây là hàng đợi Publish nhận Task loại **Post** đã hoàn thành Approval Sequence (xem [05_Content_Task_Workflow.md](05_Content_Task_Workflow.md) mục 4).
...
- AI Recommend Collaborator (FR 3.7.12, xem [06_AI_Features.md](06_AI_Features.md)) chỉ đưa ra gợi ý ứng viên ban đầu — không tác động vào trạng thái hợp tác.
