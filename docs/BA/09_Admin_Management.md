...
Toàn bộ role: ADMIN. Admin tách biệt hoàn toàn khỏi cấu trúc Agency→Workspace — xem [01_Organization_Structure.md](01_Organization_Structure.md) mục 6.
...
- FR này liên quan trực tiếp tới **Check Compliance Content** (FR 3.6.33, xem [05_Content_Task_Workflow.md](05_Content_Task_Workflow.md) mục 8) — khi hệ thống tự động phát hiện content vi phạm chính sách, nó vào hàng đợi Content Moderation Queue để Admin review lại quyết định (đúng/sai) của hệ thống tự động, không phải Admin tự kiểm duyệt từ đầu.
