...
- Có **Client Profile riêng** (xem [02_Authentication_Profile.md](02_Authentication_Profile.md) mục Client Profile) — tái sử dụng được khi Client tham gia làm việc với nhiều Agency/Workspace khác nhau, không cần khai lại thông tin mỗi lần.
...
- Xem chi tiết tại [09_Admin_Management.md](09_Admin_Management.md).

## 7. Thứ tự nghiệp vụ liên quan (tham chiếu)

Sau khi Workspace được tạo (mục 3 ở trên), bước tiếp theo là mời Client vào Workspace rồi đàm phán Media Package/Campaign — xem chi tiết đầy đủ tại [04_Media_Package_Campaign.md](04_Media_Package_Campaign.md), mục "Thứ tự chuẩn: Workspace → Package → Campaign".
