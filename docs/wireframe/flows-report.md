> ⚠️ **[STALE 2026-09-15]** User flow theo model nghiệp vụ CŨ (Workspace 1 tầng, không Agency/Package/Campaign, naming role cũ AccountManager). Xem `docs/ba/00-overview.md` cho model V2.
